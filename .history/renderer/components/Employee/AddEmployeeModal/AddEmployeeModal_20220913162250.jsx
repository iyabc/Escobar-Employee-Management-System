    ...
    if(isSuperior){
      if(firstNameError == false && lastNameError == false && addressError == false && contactNumberError == false){
        ...
        Object.keys(values).forEach((key) => {
          if(values[key] == '' && values[superiorEmployeeName] == null){
            noEmptyFields = false;
          }
        })
        if(noEmptyFields && values.superiorEmployeeName == null){
          noEmptyFields = true;
          activeEmployees.map((item) => {
            if(values.employeeFirstName == item.employeeFirstName){
              exists = true;
              id = item.employeeId;
            }
          })
        ...
        <div className={styles.group}>
          ...
          <div className={styles.group_textfields}>
            <div className={styles.group_textfields_row}>
              <TextField onChange={onChange} name="employeeLastName" label="Last" fullWidth />
