...
export default function EditEmployeeModal({ addSuccessAction, dateTime, activeEmployees,  inactiveEmployees }) {
  ...
  const superiorEmployeesOptions = [
    {key: 'employeeSuperiorEmployee', value: '', label: ''},
    {key: 'employeeSuperiorEmployee', value: 'a', label: 'a'},
    {key: 'employeeSuperiorEmployee', value: 'b', label: 'b'}
  ]
          ...
          <div className={styles.group_textfields}>
            <div className={styles.group_textfields_row}>
              ...
              <div className={styles.group_textfields_select}>
                ...
                {console.log('Position name' + values.employeePositionName)}
                <Select
                  // placeholder='Position'
                  defaultInputValue={{ 
                    key: 'employeePositionName',
                    value: JSON.stringify(activePositions[0]),
                    label: activePositions[0]
                  }}
