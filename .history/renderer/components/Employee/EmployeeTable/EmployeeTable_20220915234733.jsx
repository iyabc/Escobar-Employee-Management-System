...
export default function EmployeeTable() {
  ...
  const headCells = [
    ...
    { field: 'employeeId', headerName: 'ID', width: 'fit-content' },
    { field: 'employeeFirstName', headerName: 'First Name', width: 100 },
    { field: 'employeeLastName', headerName: 'Last Name',},
    { field: 'employeeAddress', headerName: 'Address', width: 100 },
