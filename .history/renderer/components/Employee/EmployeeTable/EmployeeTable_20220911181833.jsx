...
export default function EmployeeTable() {
  ...
  const [rows, setRows] = useState([
    { path: [(activeEmployees.map((item) => item.employeeId)), 'Address' ], employeeFirstName: (activeEmployees.map((item) => item.employeeAddress)), id: (activeEmployees.map((item) => item.employeeId)) }
  ]);
  //  search
