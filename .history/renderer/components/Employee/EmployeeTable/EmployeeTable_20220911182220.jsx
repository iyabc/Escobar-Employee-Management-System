...
export default function EmployeeTable() {
  ...
  // console.log((activeEmployees.map((item) => item.employeeId)));
  const [rows, setRows] = useState([
    // { path: [(activeEmployees.map((item) => item.employeeId)), 'Address' ], employeeFirstName: (activeEmployees.map((item) => item.employeeAddress)), id: 1 }
  ]);
  //  search
