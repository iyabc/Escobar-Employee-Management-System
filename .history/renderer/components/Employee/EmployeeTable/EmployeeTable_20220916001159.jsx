...
export default function EmployeeTable() {
  ...
  const headCells = [
    ...
    { field: 'employeeAddress', headerName: 'Address', minWidth: 160 },
    { field: 'employeeContactNumber', headerName: 'Contact', minWidth: 100 },
    { field: 'dateEmployed', headerName: 'Position', minWidth: 110 },
    { field: 'employeePositionName', headerName: 'Position', minWidth: 110 },
    { field: 'employeeTypeName', headerName: 'Type', minWidth: 110 },
    { field: 'superiorEmployeeName', headerName: 'Type', minWidth: 110 },
  ]
