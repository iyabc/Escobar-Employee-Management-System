...
export default function EmployeeTable() {
  ...
  const headCells = [
    ...
    { field: 'employeeId', headerName: 'ID', width: '100px' },
    { field: 'employeeFirstName', headerName: 'First Name', width: '100px' },
    { field: 'employeeLastName', headerName: 'Last Name',},
    { field: 'employeeAddress', headerName: 'Address', width: '100px' },
