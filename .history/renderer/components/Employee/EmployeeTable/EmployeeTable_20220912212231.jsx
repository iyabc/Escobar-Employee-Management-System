...
export default function EmployeeTable() {
  ...
  //datagrid
  const headCells = [
    { field: 'employeeId', headerName: 'ID', align: 'left', innerWidth: 'fit-content'},
    { field: 'employeeFirstName', headerName: 'First', align: 'left'},
    { field: 'employeeLastName', headerName: 'Last', align: 'left'},
    { field: 'employeeAddress', headerName: 'Address', align: 'left'},
    { field: 'employeeContactNumber', headerName: 'Contact', align: 'left'},
    { field: 'dateEmployed', headerName: 'Date Employed', align: 'left'},
    { field: 'employeePositionName', headerName: 'Position', align: 'left'},
    { field: 'employeeTypeName', headerName: 'Type', align: 'left'},
    { field: 'superiorEmployeeName', headerName: 'Superior', align: 'left'}
  ]
