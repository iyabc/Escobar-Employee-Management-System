...
export default function EmployeeTable() {
  ...
  const headCells = [
    ...
    { field: 'employeeAddress', headerName: 'Address', align: 'right' },
    { field: 'employeeContactNumber', headerName: 'Contact', align: 'right' },
    { field: 'dateEmployed', headerName: 'Date Employed', align: 'right' },
    { field: 'employeePositionName', headerName: 'Position', align: 'right' },
    { field: 'employeeTypeName', headerName: 'Type', align: 'right' },
    { field: 'superiorEmployeeName', headerName: 'Superior', align: 'right' }
  ]
