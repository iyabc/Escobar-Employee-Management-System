...
export default function EmployeeTable() {
  ...
  //datagrid
  const headCells = [
    { field: 'employeeId', headerName: 'ID', flex: 10, align: 'left'},
    { field: 'employeeFirstName', headerName: 'First', flex: 2, align: 'left'},
    { field: 'employeeLastName', headerName: 'Last', flex: 2, align: 'left'},
    { field: 'employeeAddress', headerName: 'Address', flex: 2, align: 'left'},
    { field: 'employeeContactNumber', headerName: 'Contact', flex: 1, align: 'left'},
    { field: 'dateEmployed', headerName: 'Date Employed', flex: 2, align: 'left'},
    ...
    // { field: 'employeeId', headerName: 'ID', minWidth: 'fit-content' },
    // { field: 'employeeFirstName', headerName: 'First Name', minWidth: 160 },
    // { field: 'employeeLastName', headerName: 'Last Name', minWidth: 120 },
    // { field: 'employeeAddress', headerName: 'Address', minWidth: 100, align: 'left' },
    // { field: 'employeeContactNumber', headerName: 'Contact', minWidth: 100, align: 'left' },
    // { field: 'dateEmployed', headerName: 'Position', minWidth: 110, align: 'left' },
    // { field: 'employeePositionName', headerName: 'Position', minWidth: 110, align: 'left' },
    // { field: 'employeeTypeName', headerName: 'Type', minWidth: 110, align: 'left' },
    // { field: 'superiorEmployeeName', headerName: 'Superior', minWidth: 110, align: 'left' },
  ]
