...
export default function EmployeeTable() {
  //headers
  const headCells = [
    { field: 'employeeId', headerName: 'ID', flex: 1, align: 'right'},
    { field: 'employeeFirstName', headerName: 'First', flex: 1, align: 'right'},
    { field: 'employeeLastName', headerName: 'Last', flex: 1, align: 'right'},
    ...
    { field: 'dateEmployed', headerName: 'Date Employed', flex: 1, align: 'right'},
    ...
    { field: 'superiorEmployeeName', headerName: 'Superior', flex: 1, align: 'right'}
  ]
