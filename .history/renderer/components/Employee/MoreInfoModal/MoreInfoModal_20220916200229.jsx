  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.content_outer}>
            ...
            <div className={styles.content_inner_group_name}>
                        {values.fullName}
                    </div>
                <div className={styles.content_inner_left}>
                    <div className={styles.content_inner_group}>
                        <div className={styles.content_inner_group_label}>
                            Personal Details
                        </div>
                        <div className={styles.content_inner_group_row}>
                            {values.address}
                        </div>
                        <div className={styles.content_inner_group_row}>
                            {values.contact}
