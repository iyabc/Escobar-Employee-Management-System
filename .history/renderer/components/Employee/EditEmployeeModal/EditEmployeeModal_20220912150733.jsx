    ...
    if(values.employeeTypeName != 'Owner'){
      return (
        <>
          ...
          <div className={[superiorNameError && styles.error_show, styles.error].join(" ")}>Must be letters only. Format Last, First</div>
        </>
      )
    }
  }
        ...
        <div className={styles.group}>
          ...
          <div className={styles.group_textfields}>
            ...
            <div className={styles.group_textfields_row}>
              ...
              <div className={[contactNumberError && styles.error_show, styles.error].join(" ")}>Must be 11 digits.</div>
            </div>
          </div>
        </div>
        <div className={styles.group}>
