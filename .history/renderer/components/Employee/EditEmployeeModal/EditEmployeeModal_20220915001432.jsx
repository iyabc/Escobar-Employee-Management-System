...
export default function EditEmployeeModal({ editSuccessAction, employeeData, activeEmployees, inactiveEmployees }) {
  const rest = new Rest();
  ...
  const handleSubmit = () => {
    rest.update(
      ...
      values,
      editSuccessAction,
      `Successfully edited employeee ${selectedEmployeee.employeeId}`
    )
  }
