    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.group}>
          ...
          <div className={styles.group_textfields}>
            <TextField select name="employeePositionName" label="Position" defaultValue={selectedEmployee.employeePositionName} />
            <TextField select name="employeeTypeName" label="Type" defaultValue={selectedEmployee.employeeTypeName}>
              {selectPositions.forEach((item) => {
                return (
                  <MenuItem key=shor >{item}</MenuItem>
                )
              })}
            </TextField>
