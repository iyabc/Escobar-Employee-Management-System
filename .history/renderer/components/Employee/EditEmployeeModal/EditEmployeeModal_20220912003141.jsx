...
export default function EditEmployeeModal({ editSuccessAction, employeeData }) {
  ...
  const onChange = (e) => {
    if(e.target == undefined){
      ...
      if(e.target.name == 'employeeFirstName' || e.target.name == 'employeeFirstName' || e.target.name == 'superiorEmployeeName'){

      }
      if(e.target.name == 'employeeAddress' || e.target.name == 'employeeFirstName'){
