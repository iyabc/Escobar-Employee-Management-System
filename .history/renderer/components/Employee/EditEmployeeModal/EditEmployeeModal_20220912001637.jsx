...
export default function EditEmployeeModal({ editSuccessAction, employeeData }) {
  ...
  const showSuperiorTextfield = () => {
    ...
    }else if(values.employeeTypeName == 'Owner'){
      setValues({...EditEmployeeModal, [superiorEmployeeName]:null})
    }
  }
  //submit
  const handleSubmit = () => {
      ...
      <div className={styles.content}>
        <div className={styles.group}>
          ...
          <div className={styles.group_textfields}>
            <TextField onChange={onChange} name="employeeFirstName" label="Last" defaultValue={selectedEmployee.employeeLastName} fullWidth />
