...
export default function InactiveEmployeeModal({ activateSuccessAction, inactiveEmployees }) {
  //for pdf
  const title = 'Inactive Employees Data';
  const pdfColumns = [
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.left}>
          Inactive Employees            <LocalPrintshopIcon className={styles.print_btn} onClick={() => printPdf(title, pdfColumns, pdfRows)} />

          <div className={styles.print_btn}>
            <LocalPrintshopIcon onClick={() => printPdf(title, pdfColumns, pdfRows)} />
          </div>
        </div>
