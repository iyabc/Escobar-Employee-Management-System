...
export default function EmployeeAccountForm() {
    const { 
     ...
     const handleChange = (e) => {
        ...
        if(e.target.name == 'confirmAccountPassword' || e.target.name == 'accountPassword'){
                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <TextField onChange={handleChange} type='password' name='oldPassword' value={password} label='Old Password' variant='standard' fullWidth/>
                            <TextField onChange={handleChange} type='password' name='accountPassword' label='New Password' variant='standard' fullWidth/>
                            <TextField onChange={handleChange} name='confirmAccountPassword' type='password' label='Confirm New Password' variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
