                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <TextField onChange={handleChange} type='password' name='accountPassword' label='Current Password' variant='standard' fullWidth/>
                            <TextField onChange={checkConfirmPassword} type='password' name='confirmPassword' label='Password' variant='standard' fullWidth/>
                            <TextField onChange={checkConfirmPassword} type='password' name='confirmPassword' label='Password' variant='standard' />
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
