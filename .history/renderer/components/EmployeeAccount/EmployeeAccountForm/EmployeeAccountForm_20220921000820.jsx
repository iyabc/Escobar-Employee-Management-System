                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <TextField type='password' name='accountPassword' label='Old Password' variant='standard' fullWidth/>
                            <TextField type='password' name='newPassword' label='New Password' variant='standard' fullWidth/>
                            <TextField type='password' name='accountPassword' label='Confirm New Password' variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
