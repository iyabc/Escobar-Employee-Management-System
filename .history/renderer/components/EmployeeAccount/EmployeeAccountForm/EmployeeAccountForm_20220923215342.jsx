            ...
            {toEdit ? (
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.content_group}>
                        ...
                        <FormGroup column sx={{ width: '100%', justifyContent: 'space-between' }}>
                                    <FormControlLabel
                                    value="start"
                                    control={<Checkbox />}
                                    label="Start"
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <div className={styles.content_group_checkbox}>
                                <div className={styles.content_group_checkbox_label}>
                                    Employee Management Systema
                                </div>
                                    <Checkbox disabled value={accessEmployeeManagementSystem} checked={true} />
                            </div>
                            <div className={styles.content_group_checkbox}>
                                <div className={styles.content_group_checkbox_label}>
                                    Income & Expense System
