            ...
            <div className={styles.content}>
                <div className={styles.content_group}>
                    ...
                    <div className={styles.content_group_detail}>
                        <TextField name={accountUsername} label='Name' value={employeeName} variant='standard' fullWidth/>
                        <TextField name={accountUsername} label='Username' value={accountUsername} variant='standard' fullWidth/>
                        <TextField type='password' name={accountUsername} label='Password' value={accountPassword} variant='standard' fullWidth/>
                    </div>
                </div>
                <div className={styles.content_group}>
                    <div className={styles.content_group_label}>
