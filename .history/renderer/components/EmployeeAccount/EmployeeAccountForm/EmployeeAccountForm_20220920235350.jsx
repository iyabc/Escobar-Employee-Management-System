                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <TextField onChange={handleChange} name='accountUsername' label='Username' value={accountUsername} variant='standard' fullWidth/>
                            <TextField onChange={handleChange} type='password' name='accountPassword' label='Password' value={accountPassword} variant='standard' fullWidth/>
                            <TextField onChange={checkConfirmPassword} type='password' name='confirmPassword' label='Password' value={accountPassword} variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
