...
export default function EmployeeAccountForm() {
    const { 
     ...
     const [passwordConfirm, setOldPasswordConfirm] = useState(false);
                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <TextField onChange={handleChange} name='confirmAccountPassword' value={confirmPassword} type='password' label='Confirm New Password' variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
