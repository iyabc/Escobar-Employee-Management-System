                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            <TextField className={styles.textfield} disabled name='employeeName' label='Name' value={employeeName} variant='standard' fullWidth/>
                            <TextField className={styles.textfield} disabled name='accountUsername' label='Username' value={accountUsername} variant='standard' fullWidth/>
                            <TextField className={styles.textfield} onChange={handleOldPasswordOnChange} value={oldPassword} type='password' name='oldPassword' label='Old Password' variant='standard' fullWidth/>
                            <TextField className={styles.textfield} onChange={handleNewPasswordOnChange} value={newPassword} type='password' name='accountPassword' label='New Password' variant='standard' fullWidth/>
                            <TextField className={styles.textfield} onChange={handleConfirmNewPasswordOnChange} value={confirmPassword} error={newPassword !== confirmPassword} helperText={newPassword !== confirmPassword && "New password does not match"} name='confirmPassword' type='password' label='Confirm New Password' variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            <TextField className={styles.textfield} disabled name='employeeName' label='Name' value={employeeName} variant='standard' fullWidth/>
                            <TextField className={styles.textfield} disabled name='accountUsername' label='Username' value={accountUsername} variant='standard' fullWidth/>
                            <TextField className={styles.textfield} disabled type='password' name='accountUsername' label='Password' value={oldPassword} variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
