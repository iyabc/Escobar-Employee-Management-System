                ...
                <div className={styles.content}>
                    <div className={styles.content_group}>
                        ...
                        <div className={styles.content_group_detail}>
                            ...
                            <TextField disabled onChange={handleChange} name='accountUsername' label='Username' value={accountUsername} variant='standard' fullWidth/>
                            <TextField onChange={handleChange} type='password' name='accountPassword' label='Password' variant='standard' fullWidth/>
                            <TextField onChange={checkConfirmPassword} type='password' name='confirmPassword' label='Password' variant='standard' fullWidth/>
                        </div>
                    </div>
                    <div className={styles.content_group}>
                        <div className={styles.content_group_label}>
