...
export default function EditPositionModal({ employeePositionId, employeePositionName, positionActiveData }) {
  ...
  const handleSubmit = () => {
    console.log(values.employeePositionName);
    setValues
    checkIfExists();
  }
        ...
        <div className={styles.content}>
          <div className={styles.content_header}>
            ...
            <div className={styles.textfield}>
              <TextField name="employeePositionName" value={values.employeePositionName} label="Employee Position Name" variant="standard" fullWidth />
          </div>
        </div>
