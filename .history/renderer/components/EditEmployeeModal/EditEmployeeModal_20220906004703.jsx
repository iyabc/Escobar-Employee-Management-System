...
function EditEmployeeModal({id, last_name, first_name, employee_contact, employee_address, employee_type, employee_position, superior_employee, date_employed}) {
  ...
  const handlePositionChange = (e) => {
    ...
    setValues({...values, [employee_position]:position});
  };
  //get types data
  ...
  const handleTypeChange = (e) => {
    ...
    setValues({...values, [employee_type]:type})
  };
  ...
  const onChangeInput = (e) => {
    ...
    //   }
    // }
    if(e.target.name == "employee_type"){
      console.log("changine type")
    }
    if(e.target.name == "employee_position"){
      console.log("changine type")
    }
