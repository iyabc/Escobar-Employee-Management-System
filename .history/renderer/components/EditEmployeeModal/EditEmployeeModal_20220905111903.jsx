...
function EditEmployeeModal({id, last_name, first_name, employee_contact, employee_address, employee_type, employee_position, superior_employee}) {
  ...
  function checkIfSuperior(emp_type) {
    if(emp_type == "Owner"){
      return (
        <TextField id="last_name" label="Superior Name" variant="standard" value="" fullWidth />
      )
    }else {
      return (
        <TextField id="last_name" label="Superior Name" variant="standard" defaultValue={superior_employee} fullWidth required />
      )
    }
  }
    ...
    <div className={styles.container}>
      <form className={styles.form_box}>
        ...
        <div className={styles.row}>
          <TextField id="last_name" label="Last Name" variant="standard" defaultValue={last_name} fullWidth required />
          <TextField id="first_name" label="First Name" variant="standard" defaultValue={first_name} fullWidth required />
        </div>
        <div className={styles.row}>
