...
function EditEmployeeModal({id, last_name, first_name, employee_contact, employee_address, employee_type, employee_position, superior_employee}) {
  ...
  const checkIfSuperior = (emp_type) => {
    if(emp_type != "Owner"){
      return (
    ...
    <div className={styles.container}>
      <form className={styles.form_box}>
        ...
        <div className={styles.row}>
          <TextField id="last_name" label="Last Name" variant="standard" defaultValue={last_name} onChange={(e) => setFirstName(e.target.value)} fullWidth required />
