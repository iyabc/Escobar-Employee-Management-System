    ...
    <div className={styles.container}>
      <form onSubmit={handleSubmit} className={styles.form_box}>
        ...
        <div className={styles.row}>
          <TextField name="last_name" label="Last Name" variant="standard" defaultValue={last_name} onChange={(e) => setFirstName(e.target.value)} fullWidth required />
          <TextField name="first_name" label="First Name" variant="standard" defaultValue={first_name} onChange={handleInput} fullWidth required />
        </div>
        <div className={styles.row}>
        ...
        <div className={styles.row}>
          <FormControl fullWidth>
                <InputLabel name="demo-simple-select-label">Position</InputLabel>
                <Select
                  value={position}
                  label="Position"
          ...
          <FormControl fullWidth>
            <InputLabel bane="demo-simple-select-label">Types</InputLabel>
            <Select
              value={type}
              label="Type"
