...
function EditEmployeeModal({id, last_name, first_name, employee_contact, employee_address, employee_type, employee_position, superior_employee, date_employed}) {
  ...
  const [errorlast_name, seterrorlast_name] = useState(true);
  const [errorfirst_name, seterrorfirst_name] = useState(true);
  const [erroremployee_address, seterroremployee_address] = useState(true);
  const [erroremployee_contact, seteerroremployee_contact] = useState(true);
  const [errorsuperior_employee, seterrorsuperior_employee] = useState(true);
  const textFields = [
    {
      id:1,
      name:"last_name",
