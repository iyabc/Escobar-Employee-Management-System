  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.form}>
       ...
       <div className={styles.row}>
        <button className={styles.btn_container} onClick={postCheckIn}><BigButton label="IN" link=""/></button>
        <button className={styles.btn_container} onClick={postCheckOut}><BigButton label="OUT" link=""/></button>
       </div>
      </div>
    </div>
  )
