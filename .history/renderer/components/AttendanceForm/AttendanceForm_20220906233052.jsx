  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.form}>
       ...
       <div className={styles.row}>
        <div className={styles.btn_container} onClick={postCheckInCheckOut}><BigButton label="IN" link=""/></div>
        <div className={styles.btn_container} onClick={postCheckInCheckOut}><BigButton label="OUT" link=""/></div>
       </div>
      </div>
