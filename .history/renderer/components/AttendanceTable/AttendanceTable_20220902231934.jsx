...
// function createData(attendanceId, employee_id, check_in, check_out) {
//   return { attendanceId, employee_id, check_in, check_out };
// }
...
//       return String(row.attendanceId).includes(searchValue) || row.employee_id.toLowerCase().includes(searchValue.toLowerCase()) ;
//     });
