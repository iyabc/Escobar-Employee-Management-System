...
export default function AttendanceTable() {
  ...
  const requestSearch = (searchValue) => {
    const filteredRows = fetchedData.filter((row) => {
      return String(row.employeeAttendanceJoinId).includes(searchValue) || row.employeeName.toLowerCase().includes(searchValue.toLowerCase()) || String(row.attendanceTime).toLowerCase.includes(searchValue.toLowerCase) || row.attendanceType.toLowerCase.includes(searchValue.toLowerCase);
      });
