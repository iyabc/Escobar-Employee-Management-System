    ...
    <div className={styles.container}>
        ...
        <div className={styles.footer}>
            <div className={styles.user_container}>
                <div className={styles.current_user}>Panes, Julienne Andrea Sentorias fsdfsd fsdfsdfsdsad fdsfsfsdfsdfsadsadsssssssssssssssssaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</div>
