            ...
            <ul>
                ...
                <li>
                    ...
                    href='/EmployeeAttendancePage/EmployeeAttendancePage'>
                        <div className={[viewattendanceState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Attendance</div>
                    </Link>
                </li>
                <li>
                    <Link 
                    href='/EmployeeAccountPage/EmployeeAccountPage'>
                        <div className={[viewaccountState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Account</div>
                    </Link>
                </li>
            </ul>      
        </div>
