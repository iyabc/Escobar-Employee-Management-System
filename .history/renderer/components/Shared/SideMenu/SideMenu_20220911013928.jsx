...
function SideMenu({ homeState, viewattendanceState, viewemployeeState, viewpositionsState }) {
  return (
            ...
            <ul>
                ...
                <li>
                    ...
                    href='/AttendancePage/AttendancePage'>
                        <div className={[viewattendanceState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Attendance Table</div>
                    </Link>
                </li>
                <li>
                    ...
                    href='/EmployeePage/EmployeePage'>
                        <div className={[viewemployeeState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Employee Table</div>
                    </Link>
                    <Link 
