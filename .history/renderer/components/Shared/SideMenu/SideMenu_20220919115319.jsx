...
function SideMenu({ homeState, viewattendanceState, viewemployeeState, viewpositionsState, viewtypesState }) {
  return (
            ...
            <ul>
                ...
                <li>
                    ...
                    href='/AccountsPage/AccountsPage'>
                        <div className={[viewtypesState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Accounts</div>
                    </Link>
                </li>
            </ul>      
        </div>
