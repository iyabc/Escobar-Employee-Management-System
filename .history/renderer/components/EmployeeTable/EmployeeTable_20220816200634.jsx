...
const originalRows = [
  createData(100, 'Panesaaaaaaaaaaaaaa', 'Julienne Andrea', '09218186805', 'Blk 7 L5 Luzville Subdivision, Panacan, Davao City, Davao del Sur, Philippines', 356.90, ' Admin'),
            ...
            <TableRow>
                {Employee.employee.map((item) => (
                    <TableCell
                        key={item.id}
                        align='left'
                        style={{ minWidth: item.minWidth, maxWidth: 100, fontSize: 13, fontWeight: 900 }}
                    >
                    {item.label}
                  </TableCell>
                ))}
