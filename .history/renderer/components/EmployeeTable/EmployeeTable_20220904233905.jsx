...
const handleClickEdit = (selected, rows) => {
} 
      ...
      >
        ...
        {numSelected == 1 ? (
            <Tooltip title="Edit Employee">
              ...
              // onClick={handleClickEdit(selected, rows)}
              >
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        {/* <button onClick={() => console.log(selected)}>edsasit</button> */}
        <button onClick={handleOpenEditModal}>edsasit</button>
