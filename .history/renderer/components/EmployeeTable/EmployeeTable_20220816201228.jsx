        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="left" style={{ maxHeight: 50, maWidth: 100, overflow: scroll }}>{row.last_name}</TableCell>
              <TableCell align="left" style={{ maxHeight: 50, maWidth: 100, overflow: scroll }}>{row.first_name}</TableCell>
