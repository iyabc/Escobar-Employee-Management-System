...
const headCells = [
  ...
  { id: 'employeeAddress', label: 'Address', minWidth: 160, align: 'right' },
  { id: 'employeePosition', label: 'Position', minWidth: 110, align: 'right' },
  { id: 'employeeType', label: 'Type', minWidth: 110, align: 'right' },
];
    ...
    <div className={styles.container}>
      ...
      <EnhancedTableToolbar numSelected={selected.length} />
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.employeePosition}</TableCell>
        ...
        <Modal open={openAddModal} onClose={handleCloseAddModal}>
          <Box className={styles.modal}>
            <div className={styles.close_btn} onClick={handleCloseAddModal}><CloseIcon /> a</div>
            <AddEmployeeModal />
          </Box>
        </Modal>
