        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="left" style={{ maxHeight: 10, maxWidth: 100, overflowY: scroll }}>{row.last_name}</TableCell>
              <TableCell align="left" style={{ maxHeight: 10, maxWidth: 100, overflow: scroll }}>{row.first_name}</TableCell>
              <TableCell align="left" >{row.contact_num}</TableCell>
              <TableCell align="left" style={{ maxHeight: 10, maxWidth: 100, overflow: scroll }}>{row.address}</TableCell>
