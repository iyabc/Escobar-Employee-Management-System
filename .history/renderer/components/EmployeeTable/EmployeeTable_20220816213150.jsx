...
export default function EmployeeTable() {
    ...
    const requestSearch = (searchValue) => {
        const filteredRows = originalRows.filter((row) => {
            console.log(row.toString(employee_id));
            // if(row.toString(employee_id).includes(searchValue)){
            //     return row.toString(employee_id).includes(searchValue);
            // }else if(row.last_name.toLowerCase().includes(searchValue.toLowerCase())){
            //     return row.last_name.toLowerCase().includes(searchValue.toLowerCase());
            // }else if(row.last_name.toLowerCase().includes(searchValue.toLowerCase())){
            //     return row.last_name.toLowerCase().includes(searchValue.toLowerCase());
            // }else if(row.first_name.toLowerCase().includes(searchValue.toLowerCase())){
