...
export default function EnhancedTable() {
  ...
  //edit modal
  const [openEditModal, setOpenEditModal] = useState(rows.map((item) => false)); //ga work sya pero dili dapat
  ...
  const handleActiveEmployees = (data) => {
    setRows(setActiveEmployees(data));
  };
  const getAllActiveIngredients = () => {
    rest.get(`${INITIAL_URL}/employees`, handleActiveEmployees);
  };
  // useEffect(() => {
  //   const getData = async () => {
