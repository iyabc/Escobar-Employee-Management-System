...
const originalRows = [
  createData(100, 'Panesaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'Julienne Andrea', '09218186805', 'Blk 7 L5 Luzville Subdivision, Panacan, Davao City, Davao del Sur, Philippines', 356.90, ' Admin'),
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="left" style={{ maxHeight: 50, maWidth: 100, overflow: scroll }}>{row.address}</TableCell>
