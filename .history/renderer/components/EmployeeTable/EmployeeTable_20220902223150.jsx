...
// function createData(employeeId, employeeLastName, employeeFirstName, employeeContact, employeeAddress, employeeType) {
//   return { employeeId, employeeLastName, employeeFirstName, employeeContact, employeeAddress, employeeType };
// }
...
export default function EnhancedTable() {
  ...
  const requestSearch = (searchValue) => {
    const filteredRows = Employee.employeeData.filter((row) => {
      return String(row.employeeId).includes(searchValue) || row.employeeLastName.toLowerCase().includes(searchValue.toLowerCase()) || row.employeeFirstName.toLowerCase().includes(searchValue.toLowerCase()) || row.employeeType.toLowerCase().includes(searchValue.toLowerCase()) || row.employeeAddress.toLowerCase().includes(searchValue.toLowerCase());
    });
    setRows(filteredRows);
  };
  const cancelSearch = () => {
  ...
  // console.log(rows)
  console.log(typeof(Employee.employeeData))
  //edit modal
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.employeeContact}</TableCell>
                      <TableCell align="right">{row.employeeAddress}</TableCell>
                      <TableCell align="right">{row.employeeDailyWage}</TableCell>
