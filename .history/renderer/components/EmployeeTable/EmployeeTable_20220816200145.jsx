...
const originalRows = [
  createData(100, 'Panes', 'Julienne Andrea', '09218186805', 'Blk 7 L5 Luzville Subdivision, Panacan, Davao City, Davao del Sur, Philippinesaaaaaaaaaaaaaaa', 356.90, ' Admin'),
            ...
            <TableRow>
                {Employee.employee.map((item) => (
                    <TableCell
                        key={item.id}
                        align='center'
                        style={{ minWidth: item.minWidth, maxWidth: 100, overflow: scroll }}
                    >
                    {item.label}
                  </TableCell>
                ))}
