...
export default function EnhancedTable() {
  ...
  console.log(rows);
  //edit modal
  const [openEditModal, setOpenEditModal] = useState(rows.map((item) => false));
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <Button
                            ...
                            onClick={() => handleOpenEditModal(this.index)}
                        >
                          <EditIcon />
                        </Button>
                      </TableCell>
                      <Modal open={openEditModal[index]} onClose={() => handleCloseEditModal(index)}>
                        <Box className={styles.modal}>
                          {/* <div className={styles.close_btn} onClick={handleCloseEditModal}><CloseIcon /></div> */}
                          <EditEmployeeModal
                            id={row.employeeId}
