  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.row}>
          <TextField value={employeeFirstName} onChange={firstNameChange} label="Last Name" variant="standard" fullWidth required />
          <TextField label="First Name" variant="standard" fullWidth required />
        </div>
        <div className={styles.row}>
          <TextField label="Address" variant="standard" fullWidth required />
          <TextField label="Contact Number" variant="standard" fullWidth required />
        </div>
        <div className={styles.row}>
