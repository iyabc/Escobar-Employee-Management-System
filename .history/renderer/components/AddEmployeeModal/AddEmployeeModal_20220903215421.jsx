  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.row}>
          <TextField value={firstName} onChange={changeHandler} label="First Name" variant="standard" fullWidth required />
          <TextField value={lastName} onChange={changeHandler} label="Last Name" variant="standard" fullWidth required />
        </div>
        <div className={styles.row}>
          <TextField value={address} onChange={changeHandler} label="Address" variant="standard" fullWidth required />
          <TextField value={contact} onChange={changeHandler} label="Contact Number" variant="standard" fullWidth required />
        </div>
        <div className={styles.row}>
