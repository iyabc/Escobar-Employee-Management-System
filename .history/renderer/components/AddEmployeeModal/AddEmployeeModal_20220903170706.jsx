...
export default function AddEmployeeModal() {
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.row}>
          <FormControl fullWidth sx={{ minWidth:"fit-content", display:"flex", alignContent:"center", color:"red" }}>
            ...
            <FormControl fullWidth sx={{ minWidth:"fit-content", display:"flex", alignItems:"cente" }}>
