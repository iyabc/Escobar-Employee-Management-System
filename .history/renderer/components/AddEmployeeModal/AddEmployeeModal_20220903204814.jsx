...
export default function AddEmployeeModal() {
  ...
  const postNewEmployee = (e) => {
    const iad = employeesLength + 1;
    console.log(iad, lastName, firstName, contact, address, position, type);
    e.preventDefault();
    axios.post("https://my-json-server.typicode.com/iyabc/mockend/employees", {
      ...
      employeeType: type
    }).then(response => console.log("New Data", response)).catch(err => console.log(err.response.data));
  }
