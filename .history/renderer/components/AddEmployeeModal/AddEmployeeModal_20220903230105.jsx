    ...
    return (
      <form className={styles.container} onSubmit={this.submitHandler}>
          ...
          <div className={styles.row}>
            <input type="text" name="firstName" value={firstName} onChange={this.changeHandler} label="First Name" required />
            <input type="text" name="lastName" value={lastName} onChange={this.changeHandler} label="Last Name" required />
          </div>
          <div className={styles.row}>
            <input type="text" name="address" value={address} onChange={this.changeHandler} label="Address" required />
            <input type="text" name="contact" value={contact} onChange={this.changeHandler} label="Contact Number" required />
          </div>
          {/* <div className={styles.row}>
          ...
          <button type="submit" className={styles.row}>submit
