    ...
    return (
      <form className={styles.container} onSubmit={this.submitHandler}>
          ...
          <div className={styles.row}>
            <input type="text" name="firstName" value={firstName} onChange={this.changeHandler} label="First Name" variant="standard" fullWidth required />
            <input type="text" name="lastName" value={lastName} onChange={this.changeHandler} label="Last Name" variant="standard" fullWidth required />
          </div>
          <div className={styles.row}>
            <input type="text" name="address" value={address} onChange={this.changeHandler} label="Address" variant="standard" fullWidth required />
            <input type="text" name="contact" value={contact} onChange={this.changeHandler} label="Contact Number" variant="standard" fullWidth required />
          </div>
          {/* <div className={styles.row}>
