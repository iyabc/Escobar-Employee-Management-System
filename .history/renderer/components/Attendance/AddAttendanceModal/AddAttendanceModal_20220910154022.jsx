...
export default function AddAttendanceModal({ addSuccessAction, employeeName, attendanceType, attendancyeTime }) {
    const rest = new Rest();
    ...
    const handleSubmit = () => {
        ...
        rest.add(
            ...
            addedAttendance,
            addSuccessAction,
            `Successully added attendance for ${addedAttendance.employeeName} @ ${newAttendanceTime}`
        );
    }
