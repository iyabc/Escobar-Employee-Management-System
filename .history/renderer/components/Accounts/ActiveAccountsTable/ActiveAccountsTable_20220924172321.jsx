...
export default function ActiveAccountsTable({ reload, activeAccounts, activeEmployees }) {
  ...
  const pdfColumns = [
    ...
    { header:"Inventory Management System", dataKey: 'accessInventoryManagementSystem' },
    { header:"Employee Management System", dataKey: 'accessEmployeeManagementSystem' },
    { header:"Income And Expense System", dataKey: 'accessIncomeAndExpenseSystem' },
    { header:"Ordering System", dataKey: 'accessOrderingSystem' }
  ]
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.left}>
          Active Accounts
          <Tooltip title='Print Active Accounts'>a
