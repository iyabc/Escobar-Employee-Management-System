...
export default function ActiveAccountsTable({ reload, activeAccounts, activeEmployees }) {
  ...
  const pdfColumns = [
    ...
    { header:"Name", dataKey: 'accountUsername' },
    { header:"Time", dataKey: 'accessInventoryManagementSystem' },
    { header:"Type", dataKey: 'accessEmployeeManagementSystem' }
    { header:"Time", dataKey: 'accessIncomeAndExpenseSystem' },
    { header:"Type", dataKey: 'accessOrderingSystem' }
  ]
