      ...
      <div className={styles.table}>
        ...
        <Modal open={openEditModal} onClose={handleCloseEditModal}>
            <div className={styles.modal}>
              ...
              accountId={selectedValues.map((item) => item.accountId)}
              accountUsername={selectedValues.map((item) => item.accountUsername)}
              accountPassword={selectedValues.map((item) => item.accountPassword)}
              employeeName={selectedValues.map((item) => item.employeeName)}
              accessInventoryManagementSystem={selectedValues.map((item) => item.accessInventoryManagementSystem)}
              accessEmployeeManagementSystem={selectedValues.map((item) => item.accessEmployeeManagementSystem)}
              accessIncomeAndExpenseSystem={selectedValues.map((item) => item.accessIncomeAndExpenseSystem)}
              accessOrderingSystem={selectedValues.map((item) => item.accessOrderingSystem)}
              isActive={selectedValues.map((item) => item.isActive)}
              />
            </div>
        </Modal>
