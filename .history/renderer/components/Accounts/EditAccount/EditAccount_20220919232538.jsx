            ...
            <div className={styles.content_inner}>
                ...
                <div className={styles.content_inner_right}>
                    ...
                    <div className={styles.content_inner_row}>
                        ...
                        <Checkbox onChange={onChange} name='accessInventoryManagementSystem' defaultChecked={accessInventoryManagementSystem} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Employee Management System:&nbsp;
                        <Checkbox onChange={onChange} name='accessEmployeeManagementSystem' defaultChecked={accessEmployeeManagementSystem}  />
                    </div>
                    <div className={styles.content_inner_row}>
                        Income & Expense System:&nbsp;
                        <Checkbox onChange={onChange} name='accessIncomeAndExpenseSystem' defaultChecked={accessIncomeAndExpenseSystem} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Ordering System:&nbsp;
                        <Checkbox onChange={onChange} name='accessOrderingSystem' defaultChecked={accessOrderingSystem} />
                    </div>
                </div>
            </div>
        </div> 
