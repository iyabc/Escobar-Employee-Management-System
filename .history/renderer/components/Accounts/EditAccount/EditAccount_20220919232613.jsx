            ...
            <div className={styles.content_inner}>
                ...
                <div className={styles.content_inner_right}>
                    ...
                    <div className={styles.content_inner_row}>
                        ...
                        <Checkbox handleChange={handleChange} name='accessInventoryManagementSystem' defaultChecked={accessInventoryManagementSystem} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Employee Management System:&nbsp;
                        <Checkbox handleChange={handleChange} name='accessEmployeeManagementSystem' defaultChecked={accessEmployeeManagementSystem}  />
                    </div>
                    <div className={styles.content_inner_row}>
                        Income & Expense System:&nbsp;
                        <Checkbox handleChange={handleChange} name='accessIncomeAndExpenseSystem' defaultChecked={accessIncomeAndExpenseSystem} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Ordering System:&nbsp;
                        <Checkbox handleChange={handleChange} name='accessOrderingSystem' defaultChecked={accessOrderingSystem} />
                    </div>
                </div>
            </div>
        </div> 
