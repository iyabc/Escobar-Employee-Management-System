  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.header}>
            Editing account: <span style={{ fontWeight: 700, textTransform: "uppercase"}}>{accountUsername}</span>
        </div>
        <div className={styles.content}>
          <div className={styles.content_header}>
            ...
            <div className={styles.textfield}>
              <TextField onChange={handleChange} name="accountUsername" label="Employee Type Name" variant="standard" fullWidth />
          </div>
        </div>
