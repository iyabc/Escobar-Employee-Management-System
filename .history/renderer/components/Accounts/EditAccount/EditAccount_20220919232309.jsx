            ...
            <div className={styles.content_inner}>
                ...
                <div className={styles.content_inner_right}>
                    ...
                    <div className={styles.content_inner_row}>
                        ...
                        <Checkbox name='accessInventoryManagementSystem' defaultValue={checked} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Employee Management System:&nbsp;
                        <Checkbox name='accessEmployeeManagementSystem' defaultValue={true}  />
                    </div>
                    <div className={styles.content_inner_row}>
                        Income & Expense System:&nbsp;
                        <Checkbox name='accessIncomeAndExpenseSystem' defaultValue={true} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Ordering System:&nbsp;
                        <Checkbox name='accessOrderingSystem' defaultValue={true} />
                    </div>
                </div>
            </div>
        </div> 
