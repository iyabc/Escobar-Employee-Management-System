            ...
            <div className={styles.content_inner}>
                ...
                <div className={styles.content_inner_right}>
                    ...
                    <div className={styles.content_inner_row}>
                        ...
                        <Checkbox onChange={handleChange} name='accessInventoryManagementSystem' defaultChecked={accessInventoryManagementSystem[0]} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Employee Management System:&nbsp;
                        <Checkbox onChange={handleChange} name='accessEmployeeManagementSystem' defaultChecked={accessEmployeeManagementSystem[0]}  />
                    </div>
                    <div className={styles.content_inner_row}>
                        Income & Expense System:&nbsp;
                        <Checkbox onChange={handleChange} name='accessIncomeAndExpenseSystem' defaultChecked={accessIncomeAndExpenseSystem[0]} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Ordering System:&nbsp;
                        <Checkbox onChange={handleChange} name='accessOrderingSystem' defaultChecked={accessOrderingSystem[0]} />
                    </div>
                </div>
            </div>
        </div> 
