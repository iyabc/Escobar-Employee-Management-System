            ...
            <div className={styles.content_inner}>
                ...
                <div className={styles.content_inner_right}>
                    ...
                    <div className={styles.content_inner_row}>
                        ...
                        <Checkbox onChange={handleChange} name='accessEmployeeManagementSystem' defaultChecked={accessEmployeeManagementSystem}  />
                    </div>
                    <div className={styles.content_inner_row}>
                        Income & Expense System:&nbsp;
                        <Checkbox onChange={handleChange} name='accessIncomeAndExpenseSystem' defaultChecked={accessIncomeAndExpenseSystem} />
                    </div>
                    <div className={styles.content_inner_row}>
                        Ordering System:&nbsp;
