...
import { IconButton, Modal, Toolbar, Tooltip } from '@mui/material';
        ...
        <div className={styles.container}>
            ...
            <Modal open={openEditModal} onClose={handleCloseEditModal} >
                <div className={styles.modal}>
                  {console.log(arrEdit.map((item) => item.employeePositionId))}
                  <EditPositionModal
                    employeePositionId={arrEdit.employeePositionId}
                    employeePositionName={arrEdit.employeePositionName}
                  />
                </div>
            </Modal>
        </div>
