            ...
            <Modal open={openEditModal} onClose={handleCloseEditModal} >
                <div className={styles.modal}>
                  <EditPositionModal
                    ...
                    employeePositionId={arrEdit.map((item) => item.employeePositionId)}
                    employeePositionName={arrEdit.map((item) => item.employeePositionName)}
                    positionActiveData={positions}
                  />
                </div>
            </Modal>
            <Modal open={openInactivateModal} onClose={handleCloseInactivatateModal} >
                <div className={styles.modal}>
