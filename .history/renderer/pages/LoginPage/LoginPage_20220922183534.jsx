...
export default function LoginPage() {
    ...
    const handleUsernameOnChange = (event) => {
      ...
      // );
      accountOnChange({...account, [account.accountUsername]: event.target.value});
    };
    const handlePasswordOnChange = (event) => {
      ...
      //   account.accessOrderingSystem
      // )
      accountOnChange({...account, [account.accountPassword]: event.target.value});
    };
    ...
    const handleAdminLogin = () => {
      // console.log(account)
      console.log(account.accessInventoryManagementSystem)
      // rest.login(
      //   `${INITIAL_URL}/login`,
      //   account,
