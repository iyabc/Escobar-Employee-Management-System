  ...
  return (
    <div className={styles.outer_container}>
        <div className={styles.inner_container}>
            ...
            <div className={styles.row}>
                <TextField helperText="Must be 11 digits." id="contact_num" label="Contact Number" variant="standard" fullWidth required />
                P<TextField id="daily_wage" label="Daily Wage" variant="standard" fullWidth required />
                <Box sx={{ minWidth: 120 }}>
